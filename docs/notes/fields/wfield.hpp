...
namespace weaponfield
{
    ...
    struct WeaponDef
    {
        ...
        uint64_t unka50;
        WeaponDefProperties *properties;
        uint64_t unka60;
        uint64_t unka68;
        XModel* viewmodel;
        ...
        uint64_t unkc50;
        uint64_t unkc58;
        GfxImageHandle gadgetIconAvailable;
        GfxImageHandle gadgetIconUnavailable;
        uint64_t unkc70;
        uint64_t unkc78;
        uint64_t unkc80;
        uint64_t unkc88;
        ...
        uint64_t unkea8;
        uint64_t unkeb0;
        ObjectivePtr weaponHeadObjective;
        uint64_t unkec0;
        XModel *projectilemodel; // 0xec8
        uint64_t unked0;
        uint64_t unked8;
        uint64_t unkee0;
        uint64_t unkee8;
        uint64_t unkef0;
        XModel *var_4bcd08b0; // 0xef8
        uint64_t unkf00;
        uint64_t unkf08;
        uint64_t unkf10;
        uint64_t unkf18;
        ...
        uint64_t unk1010;
        uint64_t unk1018;
        ScriptBundle *customsettings;   // 0x1020
        ScriptBundle *shrapnelsettings; // 0x1028
        ScriptBundle *var_2e4a8800; // 0x1030
        uint64_t unk1038;
        uint64_t unk1040;
        uint64_t unk1048;
        ScriptBundle *var_8456d4d; // 0x1050
        uint64_t unk1058;
        uint64_t unk1060;
        uint64_t unk1068;
        uint64_t unk1070;
    ...
    struct WeaponDefProperties
    {
        ...
        uint64_t unk10;
        uint64_t unk18;
        const char *var_f56ac2bd;    // 0x20
        const char *spawninfluencer; // 0x28
